...
public class PingNetEntity {
    ...
    /*
     TODO：ping ip花费的总时间
     */
    private String pingTimeTotal;
    /*
     TODO：ping ip成功次数
     */
    private String pingSuccessCount;

    public String getPingSuccessCount() {
        return pingSuccessCount;
    }

    public void setPingSuccessCount(String pingSuccessCount) {
        this.pingSuccessCount = pingSuccessCount;
    }

    public String getPingTimeTotal() {
        return pingTimeTotal;
    }

    public void setPingTimeTotal(String pingTimeTotal) {
        this.pingTimeTotal = pingTimeTotal;
    }
